...
Обновляй, основываясь на истории действий. Раздели долгосрочный контекс и текущую информацию. Для давних действий уменьшай детализацию описания, а со временем - удалай. Нужно не ответить на сообщение а обновить контескт. Следи за временем и иногда добавляй временные помтки к записям. Группируй записи по времени. Долгосрочный контекст меняй реже, чем текущий. Текущий контекст меняй чаще.
